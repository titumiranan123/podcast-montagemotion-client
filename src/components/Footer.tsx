...
const Footer: React.FC = () => {
    return (
        <div className='max-w-[1240px] lg:px-0 px-4 mx-auto mt-10 rounded-md '>
            <div className='bg-[#0E141E] px-5 md:px-[72px] flex justify-between items-center py-5  lg:w-[1200px] lg:h-[244px] md:flex-nowrap flex-wrap md:gap-0 gap-6'>
                <div>
            ...
            <div className='normal text-white flex justify-center items-center md:text-[20px] leading-[25.6px] text-[14px] mt-[120px]'>
