    ...
    return (
        <div className='max-w-[1240px] mx-auto '>
            <div className='flex justify-center flex-col items-center '>
                <h1 className='bg-clip-text text-transparent bg-gradient-to-b from-[#FFFFFF] to-[#25AAE1] bold text-[64px] md:w-[791px] flex justify-center items-center leading-[64px] text-center'>WHY WE ARE THE BEST OPTION FOR YOU</h1>
                <p className='regular font-[600] text-[20px] text-[#D9D9D9] leading-[25.6px]'>There are numbers of video editing agencies out there but we stand out for a reason. </p>
            </div>
